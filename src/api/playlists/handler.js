...
class PlaylistsHandler {
  ...
  async getPlaylistsHandler(request) {
    const { userId } = request.auth.credentials // sudah 5. @ dapatkan userId dari request.auth.credentials. Referensi: https://www.dicoding.com/academies/271/tutorials/17726?from=17724
